...
# - Differentiable Programming approaches in Julia
# - 
...
function latin_hypercube_sampling(f, points, grid_size)
    ...
    # candidates = [collect(LinRange(0, grid_size, Int(10 * grid_size))) for _ in points] 
    candidates = [LinRange(0, grid_size, Int(10 * grid_size)) for _ in points]  # TODO: run this to see if it resolves tha vlues-close-to-the-bordrr-problem
